...
<div class="col-12 col-md-8">
    <h1 class="mb-5 text-center">Add IPD Patient</h1>
    <form method="post" action="<?php echo base_url(); ?>add-ipd-patient" class="shadow p-3 patient-entry-form">

        <div class="form-group">
            <div class="row">
                <div class="col-md-6">
                    <label for="">OPD ID</label>

                    <input type="text" class="form-control" name="id" value="" hidden />
                    <input type="text" class="form-control" name="opdid"
                        value="<?php echo empty($row) ? '' : $row->opdid ?>" />
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <select class="form-control" name="patient">
                        <option value="<?php echo empty($row) ? '' : $row->patient ?>">
                            <?php echo empty($row) ? '' : $row->patient ?></option>
                    </select>
                    <strong class="text-danger"><?php echo form_error('patient'); ?></strong>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" readonly name="date" class="form-control"
                        value="<?php echo empty($row) ? '' : $row->date ?>" />
                </div>
                <div class="col-md-6">
