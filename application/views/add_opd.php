...
<div class="col-12 col-md-8">
    <h1 class="mb-5 text-center">Add OPD Patient</h1>
    <form method="post" action="<?php echo base_url(); ?>add-opd-patients" class="shadow p-3 patient-entry-form">

        <div class="form-group">
            <div class="row">
                <div class="col-md-6">
                    <label>Patient Type</label>
                    <input type="text" class="form-control" name="id" value="<?php echo empty($row) ? '' : $row->id ?>"
                        hidden />
                    <input type="text" class="form-control" name="opdid"
                        value="<?php echo empty($row) ? '' : $row->opdid ?>" hidden />
