    <div class="col-12 col-md-8">
        <h1 class="mb-5 position-relative text-danger d-flex">&#10009; MLC Patients</h1>
        <div class="row">
            <div class="col-6">
                <strong>View data by days</strong>
                <form method="post" action="<?php echo base_url(); ?>mlc-patients-list">
        ...
        <table class="table table-hover table-bordered table-dark shadow-md mt-3">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>First Name</th>
            ...
            <tbody>
                ...
                <?php } ?>
                <tr>
                    <td>Print data:<form method="post" action="<?php echo base_url(); ?>mlc-patients-list">
                            <select class="form-control d-inline-block w-50" name="filterBy">
                                <option value="0">Choose</option>
                                <option value="1">1 Days</option>
                                <option value="7">7 Days</option>
                    ...
                    <td class="text-right"><a href="<?php echo base_url() ?>add-mlc-patients"
                            class="btn btn-success btn-lg"> Add New Patient</a></td>
                </tr>
            </tbody>
        </table>
        <div class="pagination pagination-dark"><?php echo $links; ?></div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?php echo base_url(); ?>OpdPatient/login_validation">
