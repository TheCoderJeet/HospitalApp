    <div class="col-12 col-md-8">
        <h1 class="mb-5 position-relative text-danger d-flex">&#10009; IPD Patients</h1>
        <div class="row">
            <div class="col-6">
                <strong>View data by days</strong>
                <form method="post" action="<?php echo base_url(); ?>ipd-patients-list">
        ...
        <table class="table table-hover table-bordered table-dark shadow-md mt-3">
            ...
            <tbody>
                ...
                <?php } ?>
                <tr>
                    <td>Print data:<form method="post" action="<?php echo base_url(); ?>ipd-patients-list">
                            <select class="form-control d-inline-block w-50" name="filterBy">
                                <option value="0">Choose</option>
                                <option value="1">1 Days</option>
                                <option value="7">7 Days</option>
                            ...
                            <input class="btn btn-sm btn-secondary" type="submit" value="Print" name="printipd" />
                        </form>
                    </td>
                    <td></td>
                    <td class="text-right"></td>
                    <td class="text-right"><a href="<?php echo base_url() ?>search-opd-patients"
